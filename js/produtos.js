    ...
    <div class="col" style="margin-top: 10px;">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text preco-de"> <span>De:</span> ${formatter.format(produto.preco)}</p>
                            <p class="preco-por"><span>10x </span>${formatter.format(produto.preco)} <span>sem juros</span></p>
