const produtos = [
    ...
    id: 56,
    code: 79852,
    title: "Mochila Constantim K9576W",
    category: "Acessórios",
    subcategory: "Bolsa",
    model:"K9576W",
    old_price:1188.00,
    price: 29.00,
    img: './img/product/bolsas/mochila-79852.jpg',
    description: ""
    },
    {
        id: 57,
        code: 79851,
        title: "Mochila Constantim K9590W-E",
        category: "Acessórios",
        subcategory: "Bolsa",
        model:"K9590W-E",
        old_price:1188.00,
        price: 29.00,
        img: './img/product/bolsas/mochila-79851.jpg',
        description: ""
        },
    {
        id: 1,
...
filterButtons.forEach(button => {
    button.addEventListener('click', (event) => {
        ...
        if (filter === 'all') {
            ...
            produtosFiltrados = produtos.filter(produto => produto.subcategory === filter);
        }

        ListaEQuantidadesProdutos(produtosFiltrados);
    });
});
